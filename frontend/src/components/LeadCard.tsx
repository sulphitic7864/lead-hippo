...
export function LeadCard({ lead }: { lead: PublicLead }) {
  ...
  function getTradeBadgeStyle(tradeName: string) {
    const colors = [
      {
        bg: "rgba(96, 165, 250, 0.65)",
        shadow: "rgba(96, 165, 250, 0.25)",
      },
      {
        bg: "rgba(167, 139, 250, 0.65)",
        shadow: "rgba(167, 139, 250, 0.25)",
      },
      {
        bg: "rgba(52, 211, 153, 0.65)",
        shadow: "rgba(52, 211, 153, 0.25)",
      },
      {
        bg: "rgba(251, 191, 36, 0.65)",
        shadow: "rgba(251, 191, 36, 0.25)",
      },
      {
        bg: "rgba(244, 114, 182, 0.65)",
      ...
      {
        bg: "rgba(129, 140, 248, 0.65)",
        shadow: "rgba(129, 140, 248, 0.25)",
      },
      {
        bg: "rgba(251, 146, 60, 0.65)",
        shadow: "rgba(251, 146, 60, 0.25)",
      },
      {
        bg: "rgba(74, 222, 128, 0.65)",
        shadow: "rgba(74, 222, 128, 0.25)",
      },
      {
        bg: "rgba(248, 113, 113, 0.65)",
      ...
      {
        bg: "rgba(34, 197, 94, 0.65)",
        shadow: "rgba(34, 197, 94, 0.25)",
      },
      {
        bg: "rgba(217, 119, 6, 0.65)",
