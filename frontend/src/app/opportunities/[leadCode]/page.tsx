          ...
          <div className="detail-grid">
            ...
            <aside className="purchase-panel">
              ...
              <div className="availability">
                <Image src="/assets/spots.png" alt="" width={22} height={22} />
                <b>
                  {sold
                    ? "Sold out"
              ...
              <p className="fine-print">
                By purchasing, you agree to the <Link href="/terms">Terms</Link>{" "}
          ...
          <aside className="included-card">
            ...
            <div className="notice">
              ...
              <p>
                ...
                Purchasing access does not guarantee that you will win the work.
              </p>
            </div>
          </aside>
        </div>
